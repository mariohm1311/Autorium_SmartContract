...
contract ProofOfStake {
    ...
    Float Kparam = Kparam_calc(Float(36500,-2),Float(101,-2),Float(2,-1),Float(8,-1));
    //Float Kparam = Float(71013837700,-3);
    Float test_reward = reward(Float(36500,-2),Float(101,-2),Kparam,Float(2,-1));
    ...
    function give_guess(Float block_num) private returns (Float) {
        Float memory init_guess = Float(2420000,-9);
